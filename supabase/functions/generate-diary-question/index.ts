...
- 선택지는 4개를 만든다.
- category는 반드시 아래 중 하나로 반환한다: 식사, 수면, 컨디션, 기분, 날씨, 오늘 한 일, 일/학교, 사람, 장소/이동, 소비, 여가, 운동, 간식/커피, 특별한 사건
- 기타 입력은 앱에서 항상 제공한다.
...
- avoidCategories에 있는 소재는 특히 1번째 질문에서는 피한다.
- 같은 날짜에 이미 식사를 기록했다면 다시 식사 질문을 하지 않는다.
- 같은 질문 문장을 반복하지 않는다.
